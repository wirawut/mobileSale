...
<div class = "panel-heading" style="font-size:  ${manageGeneralRow.contentMenuModel.font_size_header}; font-family : ${manageGeneralRow.contentMenuModel.font_name}; font-style:  ${manageGeneralRow.contentMenuModel.font_style}; font-weight: ${manageGeneralRow.contentMenuModel.font_weight_header}; color: ${manageGeneralRow.contentMenuModel.font_color_header};background-color: ${manageGeneralRow.contentMenuModel.background_color_header};"><img src="image/manageBasic.png" width="35" height="35"> <a href="HomeIndex" > ตั้งค่าพื้นฐาน </a> <img src="image/right.png" width="35" height="35"> <img src="image/product_type.png" width="35" height="35"> <a href="ManageBasicIndex" > ตั้งค่าพื้นฐาน </a> <img src="image/right.png" width="35" height="35"> <img src="image/others.png" width="35" height="35"> <a href="OtherTypeIndex" > อุปกรณ์เสริม </a></div>
<div class="panel-body">
    ...
    <div class="table-responsive" style=" height: 370px; overflow: auto; ">
        <table class="table table-hover table-bordered table-striped table-responsive" >
            ...
            <tbody>
                <%int i = 1;%>
                <s:iterator value="otherTypeList" var="otherTypeRow">
                    <tr>
                        <td align="center"><%out.print(i);%></td>
                        <td>${otherTypeRow.other_type}</td>
                        <td>${otherTypeRow.detail}</td>
                        <td>${otherTypeRow.date}</td>
                        <td colspan="2">  

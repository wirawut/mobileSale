            ...
            <tbody>
                <s:iterator value="simList" var="simRow">
                    <tr style="vertical-align: middle">
                        ...
                        <td style="vertical-align: middle ">${simRow.simTypeModel.sim_type} ${simRow.sim}</td>
                        <td style="vertical-align: middle "><center><img src="${simRow.image}" width="36px" height="36px"></center></td>
                <td align="center" style="vertical-align: middle ">${simRow.price_sale}</td>
                ...
                <td align="center" style="vertical-align: middle ">${simRow.quantity}</td>
                </tr>
            </s:iterator>
            </tbody>
        </table>

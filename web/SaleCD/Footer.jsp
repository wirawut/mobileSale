            ...
            <s:form action="FooterSave" theme="simple">
                ...
                <table width="70%" align="center">
                    ...
                    <tr>
                        ...
                        <td class="form-group has-success">
                             <s:textfield name="footerModel.footer_font_name" id="inputSuccess1" cssClass="form-control" style="height: 40px"/>
                        </td>
                    </tr>
                    <tr><td></td></tr>
                    <tr>
                        ...
                        <td class="form-group has-success">
                          <s:textfield name="footerModel.footer_font_style" cssClass="form-control" style="height: 40px" />
                        </td>
                    </tr>
                    <tr><td></td></tr>
                    <tr>
                        ...
                        <td class="form-group has-success">
                             <s:textfield name="footerModel.footer_font_size" cssClass="form-control" style="height: 40px" />
                        </td>
                    </tr>
                    <tr><td></td></tr>
                    <tr>
                        ...
                        <td class="form-group has-success">
                            <s:textfield name="footerModel.footer_font_weight" cssClass="form-control" style="height: 40px"/>
                        </td>
                    </tr>
                    <tr><td></td></tr>
                    <tr>
                        ...
                        <td class="form-group has-success">
                            <s:textfield name="footerModel.footer_font_color" cssClass="form-control" style="height: 40px" />
                        </td>
                    </tr>
                    <tr><td></td></tr>
                    <tr>
                        ...
                        <td class="form-group has-success">
                           <s:textfield name="footerModel.footer_background_color" cssClass="form-control" style="height: 40px" />
                        </td>
                    </tr>
                    <tr><td></td></tr>
                    <tr>
                        ...
                        <td class="form-group has-success">
                            <s:textfield name="footerModel.footer_border_color" cssClass="form-control"  style="height: 40px"/>
                        </td>
                    </tr>
                    <tr><td></td></tr>
                    <tr>
                        ...
                        <td class="form-group has-success">
                           <s:textfield name="footerModel.footer_border_weight" cssClass="form-control" style="height: 40px" />
                        </td>
                    </tr>
                    <tr><td></td></tr>
                    <tr>
                        ...
                        <td class="form-group has-success">
                            <s:textfield name="footerModel.footer_border_style" cssClass="form-control" style="height: 40px" />
                        </td>
                    </tr>
                    <tr><td></td></tr>
                    <tr>
